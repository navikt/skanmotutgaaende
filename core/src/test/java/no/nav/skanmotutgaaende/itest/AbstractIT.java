...
public abstract class AbstractIT {
	...
	public void setUp() {
		...
		stubFor(put(urlMatching(MOTTA_DOKUMENT_UTGAAENDE_SKANNING_TJENESTE)).willReturn(aResponse()
				.withStatus(OK.value())
		...
		stubFor(put(urlMatching(MOTTA_DOKUMENT_UTGAAENDE_SKANNING_TJENESTE_INVALID_JOURNALPOST)).willReturn(aResponse()
