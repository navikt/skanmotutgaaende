...
import static no.nav.skanmotutgaaende.PostboksUtgaaendeRoute.PROPERTY_FORSENDELSE_BATCHNAVN;
import static no.nav.skanmotutgaaende.PostboksUtgaaendeRoute.PROPERTY_FORSENDELSE_FILEBASENAME;
