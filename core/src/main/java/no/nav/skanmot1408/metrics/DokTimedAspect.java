...
import no.nav.skanmot1408.constants.MDCConstants;
import no.nav.skanmot1408.exceptions.functional.AbstractSkanmot1408FunctionalException;
...
public class DokTimedAspect {
    ...
    @Around("execution (@no.nav.skanmot1408.metrics.Metrics * *.*(..))")
    ...
    private boolean isFunctionalException(Throwable e) {
        return e instanceof AbstractSkanmot1408FunctionalException;
    }
}
